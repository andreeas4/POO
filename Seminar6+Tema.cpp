...
//-----------------------------------------------------------------------------------------------------------------------------------------
	...
	{
		char* NumeProdusNou = new char[strlen(p1.np) + 1 + strlen(p1.np) + 1];
		strcpy(NumeProdusNou, p1.np);
		strcat(NumeProdusNou, " ");
		strcat(NumeProdusNou, p2.np);



		return produs(NumeProdusNou, p1.um, p1.q + p2.q, p1.pu + p2.pu);
